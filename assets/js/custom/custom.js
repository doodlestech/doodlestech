$(document).ready(function () {
  ...
  function menu(menuIcon) {
    ...
    $(".doodlestech-mobile-nav").toggleClass("menu-active");
  }
  ...
  $(".doodlestech-nav").addClass("transitionNav");
  ...
  scrollbar.addListener((status) => {
    ...
    $(".doodlestech-mobile-nav").css("top", offset.y + "px");
  });
  ...
  $(".backToTop").on("click", function (e) {
    ...
    $(".doodlestech-menu li a").removeClass("active");
  ...
  $(".doodlestech-button").on("mouseover", function (e) {
    var relX = e.pageX - $(this).offset().left;
    var relY = e.pageY - $(this).offset().top;
    $(this).find(".doodlestech-button-hover").css({ left: relX, top: relY });
    $(this).find(".doodlestech-button-hover").removeClass("desplode-circle");
    $(this).find(".doodlestech-button-hover").addClass("explode-circle");
  });

  $(".doodlestech-button").on("mouseleave", function (e) {
    var relX = e.pageX - $(this).offset().left;
    var relY = e.pageY - $(this).offset().top;
    $(this).find(".doodlestech-button-hover").css({ left: relX, top: relY });
    $(this).find(".doodlestech-button-hover").removeClass("explode-circle");
    $(this).find(".doodlestech-button-hover").addClass("desplode-circle");
  });
  ...
  $(".doodlestech-icon").each(function (i) {
  ...
  // filling gap
  var priceTableTransform = $(".doodlestech-block").css("transform");

  var translateYValue = getTranslateYValue(priceTableTransform);
  var absoluteTranslateY = Math.abs(translateYValue);

  $(".doodlestech-servcies").css("padding-bottom", absoluteTranslateY + "px");
  $(".doodlestech-block").css(
    "max-height",
  ...
  // scroll to
  $(".doodlestech-menu li a").each(function (e) {
